...
2. Implementing Magic as a payment method at checkout. (React Component, Hosted Page, Checkout ID, Link Token)
3. Adding any Magic Marketing Components as needed
...
add is_subscription is true in the checkout object for subscibe the consumer user.
