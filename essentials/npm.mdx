...
- Created a Merchant Account as per the instructions on [**Creating a Merchant Account with Magic**](https://magic-21.mintlify.app/essentials/merchant)
- Received your API key and Funding source ID  
