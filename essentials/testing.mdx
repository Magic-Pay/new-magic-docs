...
1. On the Hosted Page, once the consumer clicks on the __Pay Now__ button in the
   last step of our flow, a payment should be triggered. It should be implemented on
   the `onSuccess` function of the [**Magic Link button**](https://magic-21.mintlify.app/essentials/magic-button).
