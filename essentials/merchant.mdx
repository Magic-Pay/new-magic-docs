...
### 🖊️ To obtain the API keys set up a **Merchant Account** by filling out the [onboarding form here](https://form.jotform.com/232558696763069), or email david@joinmagic.co the below info:
