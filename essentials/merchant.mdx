...
### 🖊️ To obtain the Magic's API keys please make a sale contacts or email david@joinmagic.co. Below are examples of information we will need to successfully create a merchant account and enable Magic payment functionalities:
